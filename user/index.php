...
<body>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="../galeri/uploads/DSC02324.JPG" class="w-100" style="height: 80vh;" alt="...">
        </div>
        <div class="carousel-item">
            <img src="../galeri/uploads/DSC02374.JPG" class="w-100" style="height: 80vh;" alt="...">
        </div>
        <div class="carousel-item">
            <img src="../galeri/uploads/DSC02761.JPG" class="w-100" style="height: 80vh;" alt="...">
        </div>
    </div>
</div>
