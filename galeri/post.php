...
<div class="card">
    <div class="card-body">
		...
		$data = mysqli_query($conn, "SELECT posts.*, kategori.judul AS nama_kategori, petugas.username AS nama_petugas FROM posts JOIN kategori ON posts.kategori_id = kategori.id JOIN petugas ON posts.petugas_id = petugas.id");
            ...
            <tr>
                ...
                <td class="d-flex">
                <a href="#" class="btn btn-primary btn-md mb-3 mr-2" data-toggle="modal" data-target="#modalView<?php echo $d['id']; ?>">
    ...
    <a href="hapus_post.php?id=<?php echo $d['id']; ?>" class="btn btn-danger btn-md mb-3" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');">
